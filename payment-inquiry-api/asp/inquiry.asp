...
<% call initCodecs paymentKey = "" secretkey = "test_sk_zXLkKEypNArWmo50nX3lmeaxYG5R:" url = "https://api.tosspayments.com/v1/payments/" & paymentKey authorization = "Basic " & base64Encode(secretkey)
set req = Server.CreateObject("MSXML2.ServerXMLHTTP") req.open "GET", url, false req.setRequestHeader "Authorization", authorization req.send "" set myJSON = JSON.parse(req.responseText) httpCode =
req.status %> --
<html lang="ko">
  <head>
    <title>조회 성공</title>
