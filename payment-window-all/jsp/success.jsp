      ...
      <% if (isSuccess) { %>
        <div class="box_section" style="width: 600px">
          ...
          <div class="p-grid typography--p" style="margin-top: 50px">
            ...
            <div class="p-grid-col text--right"><%= jsonObject.get("totalAmount") %>원</div>
          </div>
          <div class="p-grid typography--p" style="margin-top: 10px">
            <div class="p-grid-col text--left"><b>주문번호</b></div>
            <div class="p-grid-col text--right"><%= jsonObject.get("orderId") %></div>
          </div>
          <div class="p-grid typography--p" style="margin-top: 10px">
            <div class="p-grid-col text--left"><b>paymentKey</b></div>
            <div class="p-grid-col text--right"><%= jsonObject.get("paymentKey") %></div>
          </div>
          <div class="p-grid">
        ...
        <div class="box_section" style="width: 600px; text-align: left">
          <b>Response Data :</b>
          <pre><div style="white-space: initial"><%= jsonObject %></div></pre>
        </div>
      ...
      <%} else { %>
        <div id="info" class="box_section" style="width: 600px">
          ...
          <div class="p-grid typography--p" style="margin-top: 50px">
            ...
            <div class="p-grid-col text--right"><%= jsonObject.get("message") %></div>
          </div>
          <div class="p-grid typography--p" style="margin-top: 10px">
